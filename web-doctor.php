    ...
    <body>    
        ...
        <div class="container recommendation_container"> 
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-center recommendation_spot_title text-info"><b><?= $data['name'] ?></b></h2>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="service-request.php?s=<?= $data['id'] ?>" class="btn btn-danger text-white text-center">Send Medical Request</a>
